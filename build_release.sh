...
export LOCALVERSION="-JBX-0.8-Hybrid"
...
zip -r "JBX-Kernel-0.8-Hybrid_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-0.8-Hybrid_$(date +"%Y-%m-%d").zip" /home/mnl-manz/razr_kdev_kernel/built
