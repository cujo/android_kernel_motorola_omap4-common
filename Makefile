...
HOSTCXXFLAGS = -O2 -Wall -fno-delete-null-pointer-checks
...
CFLAGS_MODULE   = -DMODULE -march=armv7-a -mtune=cortex-a9 -mfpu=neon -funswitch-loops -fpredictive-commoning -fgcse-after-reload -ftree-vectorize -fipa-cp-clone -fsingle-precision-constant -pipe
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
