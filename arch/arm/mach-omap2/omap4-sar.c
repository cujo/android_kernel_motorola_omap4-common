 ...
 * }
 */
static const u32 omap447x_sar_ram1_layout[][4] = {
	{EMIF1_INDEX, OMAP44XX_EMIF_SDRAM_CONFIG_2, 1, 0x00000000},
	{EMIF1_INDEX, OMAP44XX_EMIF_SDRAM_CONFIG, 1, 0x00000004},
	{EMIF1_INDEX, OMAP44XX_EMIF_SDRAM_REF_CTRL, 1, 0x00000008},
	{EMIF1_INDEX, OMAP44XX_EMIF_SDRAM_REF_CTRL_SHDW, 1, 0x0000000C},
	...
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_PADCONF_GLOBAL, 15, 0x0000017C},
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_PBIASLITE, 3, 0x000001B8},
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_HDMI_TX_PHY, 10, 0x000001C4},
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_LPDDR2IO1_0, 8, 0x000001EC},
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_BUS_HOLD, 1, 0x0000020c},
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_C2C, 1, 0x00000210},
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_EFUSE_2, 1, 0x00000214},
	{CTRL_MODULE_PAD_CORE_INDEX,
	 OMAP4_CTRL_MODULE_PAD_CORE_CONTROL_EFUSE_4, 1, 0x00000218},
	{L4CORE_INDEX, 0x2350, 1, 0x0000021c},
	{DMM_INDEX, OMAP44XX_DMM_LISA_MAP, 4, 0x00000220},
	{DMM_INDEX, OMAP44XX_DMM_LISA_LOCK, 1, 0x00000230},
	{DMM_INDEX, OMAP44XX_DMM_TILER_OR, 2, 0x00000234},
	{DMM_INDEX, OMAP44XX_DMM_PAT_VIEW, 2, 0x0000023c},
	{DMM_INDEX, OMAP44XX_DMM_PAT_VIEW_MAP, 4, 0x00000244},
	{DMM_INDEX, OMAP44XX_DMM_PAT_VIEW_MAP_BASE, 1, 0x00000254},
	{DMM_INDEX, OMAP44XX_DMM_PAT_IRQENABLE_SET, 1, 0x00000258},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DESCR, 1, 0x0000025c},
	{DMM_INDEX, OMAP44XX_DMM_PAT_AREA, 1, 0x00000260},
	{DMM_INDEX, OMAP44XX_DMM_PAT_CTRL, 1, 0x00000264},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DATA, 1, 0x00000268},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DESCR + 0x10, 1, 0x0000026c},
	{DMM_INDEX, OMAP44XX_DMM_PAT_AREA + 0x10, 1, 0x00000270},
	{DMM_INDEX, OMAP44XX_DMM_PAT_CTRL + 0x10, 1, 0x00000274},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DATA + 0x10, 1, 0x00000278},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DESCR + 0x20, 1, 0x0000027c},
	{DMM_INDEX, OMAP44XX_DMM_PAT_AREA + 0x20, 1, 0x00000280},
	{DMM_INDEX, OMAP44XX_DMM_PAT_CTRL + 0x20, 1, 0x00000284},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DATA + 0x20, 1, 0x00000288},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DESCR + 0x30, 1, 0x0000028c},
	{DMM_INDEX, OMAP44XX_DMM_PAT_AREA + 0x30, 1, 0x00000290},
	{DMM_INDEX, OMAP44XX_DMM_PAT_CTRL + 0x30, 1, 0x00000294},
	{DMM_INDEX, OMAP44XX_DMM_PAT_DATA + 0x30, 1, 0x00000298},
	{DMM_INDEX, OMAP44XX_DMM_PEG_PRIO, 2, 0x0000029c},
	{DMM_INDEX, OMAP44XX_DMM_PEG_PRIO_PAT, 1, 0x000002A4},
	{L3_CLK1_INDEX, 0x508, 1, 0x000002A8},
	{L3_CLK1_INDEX, 0x510, 1, 0x000002AC},
	{L3_CLK1_INDEX, 0x808, 1, 0x000002B0},
	{L3_CLK2_INDEX, 0x1008, 1, 0x000002B4},
	{L3_CLK2_INDEX, 0x1010, 1, 0x000002B8},
	{L3_CLK2_INDEX, 0x1208, 1, 0x000002BC},
	{L3_CLK2_INDEX, 0x1408, 1, 0x000002C0},
	{L3_CLK2_INDEX, 0x140C, 1, 0x000002C4},
	{L3_CLK2_INDEX, 0x1708, 1, 0x000002C8},
	{L3_CLK2_INDEX, 0x170C, 1, 0x000002CC},
	{L3_CLK2_INDEX, 0x1808, 1, 0x000002D0},
	{L3_CLK2_INDEX, 0x180C, 1, 0x000002D4},
	{L3_CLK2_INDEX, 0x1A08, 1, 0x000002D8},
	{L3_CLK2_INDEX, 0x1A0C, 1, 0x000002DC},
	{L3_CLK2_INDEX, 0x1B08, 1, 0x000002E0},
	{L3_CLK2_INDEX, 0x1B0C, 1, 0x000002E4},
	{L3_CLK2_INDEX, 0x1C08, 3, 0x000002E8},
	{L3_CLK2_INDEX, 0x1D08, 3, 0x000002F4},
	{L3_CLK3_INDEX, 0x208, 2, 0x00000300},
	{L3_CLK3_INDEX, 0x308, 1, 0x00000308},
	{CM2_INDEX, OMAP4430_CM2_RESTORE_INST +
	    OMAP4_CM_L3INIT_USB_HOST_CLKCTRL_RESTORE_OFFSET, 1, 0x0000030C},
	{CM2_INDEX, OMAP4430_CM2_RESTORE_INST +
	    OMAP4_CM_L3INIT_USB_TLL_CLKCTRL_RESTORE_OFFSET, 1, 0x00000310},
	{CM2_INDEX, OMAP4430_CM2_RESTORE_INST +
	    OMAP4_CM_SDMA_STATICDEP_RESTORE_OFFSET, 1, 0x00000314},
	{USBTLL_INDEX, 0x400, 7, 0x00000318},
	{UHH_INDEX, 0x10, 1, 0x00000334},
	{UHH_INDEX, 0x40, 1, 0x00000338},
	{UHH_INDEX, 0x100, 384,  0x0000033C},
	{CM2_INDEX, OMAP4430_CM2_RESTORE_INST +
	    OMAP4_CM_L3INIT_USB_HOST_CLKCTRL_RESTORE_OFFSET, 1, 0x0000093C},
	{CM2_INDEX, OMAP4430_CM2_RESTORE_INST +
	    OMAP4_CM_L3INIT_USB_TLL_CLKCTRL_RESTORE_OFFSET, 1, 0x00000940},
	{CM2_INDEX, OMAP4430_CM2_RESTORE_INST +
	    OMAP4_CM_SDMA_STATICDEP_RESTORE_OFFSET, 1, 0x00000944},
};
 ...
 * SAR_RAM3 and  SAR_RAM4 layout is not listed since moslty it's handle by
 * secure software.
 * We should handle store of this layout on GP devices
 */
static const u32 omap447x_sar_ram3_layout[][4] = {
	{L4CORE_INDEX, 0x2140, 1, 0x00000000},
	{L4CORE_INDEX, 0x2104, 1, 0x00000004},
	{L4CORE_INDEX, 0x2100, 1, 0x00000008},
	{L4CORE_INDEX, 0x2354, 1, 0x0000000C},
	{L4CORE_INDEX, 0x2358, 1, 0x00000010},
	{L4CORE_INDEX, 0x235C, 1, 0x00000014},
	{L4CORE_INDEX, 0x2108, 1, 0x00000018},
	{L4CORE_INDEX, 0x210C, 1, 0x0000001C},
	{L4CORE_INDEX, 0x2110, 1, 0x00000020},
	{L4CORE_INDEX, 0x2114, 1, 0x00000024},
	{L4CORE_INDEX, 0x204088, 14, 0x00000028},
	{L4CORE_INDEX, 0x206088, 2, 0x00000060},
	{L4CORE_INDEX, 0x20C088, 30, 0x00000068},
	{L4CORE_INDEX, 0x210088, 30, 0x000000E0},
	{L4CORE_INDEX, 0x212088, 38, 0x00000158},
	{L4CORE_INDEX, 0x214088, 2, 0x000001F0},
	{L4CORE_INDEX, 0x216088, 2, 0x000001F8},
	{L4CORE_INDEX, 0x218088, 2, 0x00000200},
	{L4CORE_INDEX, 0x21C088, 2, 0x00000208},
	{L4CORE_INDEX, 0x21E088, 2, 0x00000210},
	{L4CORE_INDEX, 0x220088, 2, 0x00000218},
	{L4CORE_INDEX, 0x226088, 6, 0x00000220},
	{L4CORE_INDEX, 0x228088, 2, 0x00000238},
	{L4CORE_INDEX, 0x22A088, 14, 0x00000240},
	{L4CORE_INDEX, 0x21A088, 2, 0x00000278},
	{L4CORE_INDEX, 0x20A088, 30, 0x00000280},
	{L4PER_INDEX, 0x218, 1, 0x000002F8},
	{L4PER_INDEX, 0x220, 1, 0x000002FC},
	{L4PER_INDEX, 0x228, 1, 0x00000300},
	{L4PER_INDEX, 0x230, 1, 0x00000304},
	{L4PER_INDEX, 0x238, 1, 0x00000308},
	{L4PER_INDEX, 0x298, 2, 0x0000030C},
	{L4PER_INDEX, 0x2A0, 2, 0x00000314},
	{L4PER_INDEX, 0x2A8, 2, 0x0000031C},
	{L4PER_INDEX, 0x2B0, 2, 0x00000324},
	{L4PER_INDEX, 0x2B8, 2, 0x0000032C},
	{L4PER_INDEX, 0x304, 1, 0x00000334},
	{L4PER_INDEX, 0x31C, 1, 0x00000338},
	{L4PER_INDEX, 0x32C, 1, 0x0000033C},
	{L4PER_INDEX, 0x33C, 1, 0x00000340},
	{L4PER_INDEX, 0x34C, 1, 0x00000344},
	{L4PER_INDEX, 0x35C, 1, 0x00000348},
	{L4PER_INDEX, 0x36C, 1, 0x0000034C},
	{L4PER_INDEX, 0x37C, 1, 0x00000350},
	{L4PER_INDEX, 0x38C, 1, 0x00000354},
	{L4PER_INDEX, 0x39C, 1, 0x00000358},
	{L4PER_INDEX, 0x3AC, 1, 0x0000035C},
	{L4PER_INDEX, 0x3BC, 1, 0x00000360},
	{L4PER_INDEX, 0x3CC, 1, 0x00000364},
	{L4PER_INDEX, 0x3D4, 1, 0x00000368},
	{L4PER_INDEX, 0x3E4, 1, 0x0000036C},
	{L4PER_INDEX, 0x3F4, 1, 0x00000370},
	{L4PER_INDEX, 0x404, 1, 0x00000374},
	{L4PER_INDEX, 0x414, 1, 0x00000378},
	{L4PER_INDEX, 0x42C, 1, 0x0000037C},
	{L4PER_INDEX, 0x43C, 1, 0x00000380},
	{L4PER_INDEX, 0x44C, 1, 0x00000384},
	{L4PER_INDEX, 0x45C, 1, 0x00000388},
	{L4PER_INDEX, 0x46C, 1, 0x0000038C},
	{L4PER_INDEX, 0x47C, 1, 0x00000390},
	{L4PER_INDEX, 0x48C, 1, 0x00000394},
	{L4PER_INDEX, 0x49C, 1, 0x00000398},
	{L4PER_INDEX, 0x4AC, 1, 0x0000039C},
	{L4PER_INDEX, 0x4BC, 1, 0x000003A0},
	{L4PER_INDEX, 0x4CC, 1, 0x000003A4},
	{L4PER_INDEX, 0x4DC, 1, 0x000003A8},
	{L4PER_INDEX, 0x4EC, 1, 0x000003AC},
	{L4PER_INDEX, 0x4FC, 1, 0x000003B0},
	{L4PER_INDEX, 0x50C, 1, 0x000003B4},
	{L4PER_INDEX, 0x51C, 1, 0x000003B8},
	{L4PER_INDEX, 0x52C, 1, 0x000003BC},
	{L4PER_INDEX, 0x53C, 1, 0x000003C0},
	{L4PER_INDEX, 0x54C, 1, 0x000003C4},
	{L4PER_INDEX, 0x55C, 1, 0x000003C8},
	{L4PER_INDEX, 0x56C, 1, 0x000003CC},
	{L4PER_INDEX, 0x57C, 1, 0x000003D0},
	{L4PER_INDEX, 0x5A4, 1, 0x000003D4},
	{L4CORE_INDEX, 0x230, 1, 0x000003D8},
	{L4CORE_INDEX, 0x238, 1, 0x000003DC},
	{L4CORE_INDEX, 0x2B0, 2, 0x000003E0},
	{L4CORE_INDEX, 0x2B8, 2, 0x000003E8},
	{L4CORE_INDEX, 0x304, 1, 0x000003F0},
	{L4CORE_INDEX, 0x31C, 1, 0x000003F4},
	{L4CORE_INDEX, 0x32C, 1, 0x000003F8},
	{L4CORE_INDEX, 0x33C, 1, 0x000003FC},
	{L4CORE_INDEX, 0x354, 1, 0x00000400},
	{L4CORE_INDEX, 0x35C, 1, 0x00000404},
	{L4CORE_INDEX, 0x36C, 1, 0x00000408},
	{L4CORE_INDEX, 0x37C, 1, 0x0000040C},
	{L4CORE_INDEX, 0x38C, 1, 0x00000410},
	{L4CORE_INDEX, 0x3AC, 1, 0x00000414},
	{L4CORE_INDEX, 0x3BC, 1, 0x00000418},
	{L4CORE_INDEX, 0x3CC, 1, 0x0000041C},
	{L4CORE_INDEX, 0x3DC, 1, 0x00000420},
	{L4CORE_INDEX, 0x3EC, 1, 0x00000424},
	{L4CORE_INDEX, 0x3FC, 1, 0x00000428},
	{L4CORE_INDEX, 0x40C, 1, 0x0000042C},
	{L4CORE_INDEX, 0x41C, 1, 0x00000430},
	{L4CORE_INDEX, 0x42C, 1, 0x00000434},
	{L4CORE_INDEX, 0x43C, 1, 0x00000438},
	{L4CORE_INDEX, 0x44C, 1, 0x0000043C},
	{L4CORE_INDEX, 0x45C, 1, 0x00000440},
	{L4CORE_INDEX, 0x46C, 1, 0x00000444},
	{L4CORE_INDEX, 0x47C, 1, 0x00000448},
	{L4CORE_INDEX, 0x48C, 1, 0x0000044C},
	{L4CORE_INDEX, 0x49C, 1, 0x00000450},
	{L4CORE_INDEX, 0x4AC, 1, 0x00000454},
	{L4CORE_INDEX, 0x4BC, 1, 0x00000458},
	{L4CORE_INDEX, 0x4CC, 1, 0x0000045C},
	{L4CORE_INDEX, 0x4DC, 1, 0x00000460},
	{L4CORE_INDEX, 0x4EC, 1, 0x00000464},
	{L4CORE_INDEX, 0x4FC, 1, 0x00000468},
	{L4CORE_INDEX, 0x50C, 1, 0x0000046C},
	{L4CORE_INDEX, 0x51C, 1, 0x00000470},
	{L4CORE_INDEX, 0x52C, 1, 0x00000474},
	{L4CORE_INDEX, 0x53C, 1, 0x00000478},
	{L4CORE_INDEX, 0x54C, 1, 0x0000047C},
	{L4CORE_INDEX, 0x55C, 1, 0x00000480},
	{L4CORE_INDEX, 0x56C, 1, 0x00000484},
	{L4CORE_INDEX, 0x574, 1, 0x00000488},
	{L4CORE_INDEX, 0x584, 1, 0x0000048C},
	{L4CORE_INDEX, 0x594, 1, 0x00000490},
	{L4CORE_INDEX, 0x5A4, 1, 0x00000494},
	{L4CORE_INDEX, 0x5B4, 1, 0x00000498},
	{L4CORE_INDEX, 0x5C4, 1, 0x0000049C},
	{L4CORE_INDEX, 0x5D4, 1, 0x000004A0},
	{L4CORE_INDEX, 0x5DC, 1, 0x000004A4},
	{L4CORE_INDEX, 0x5E4, 1, 0x000004A8},
	{L4CORE_INDEX, 0x5EC, 1, 0x000004AC},
	{L4CORE_INDEX, 0x5F4, 1, 0x000004B0},
	{L4CORE_INDEX, 0x5FC, 1, 0x000004B4},
	{L4CORE_INDEX, 0x604, 1, 0x000004B8},
};
...
static void save_sar_bank3(void)
{
	...
	if (cpu_is_omap446x())
		...
		sar_save(ARRAY_SIZE(omap447x_sar_ram3_layout), SAR_BANK3_OFFSET,
			 omap447x_sar_ram3_layout);
	else
