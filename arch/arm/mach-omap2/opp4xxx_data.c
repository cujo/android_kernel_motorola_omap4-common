...
#define OMAP4430_VDD_MPU_OPP_UVA_UV 		 985000 		/* 100 */
#define OMAP4430_VDD_MPU_OPP50_UV 		1000000 		/* 200 */
#define OMAP4430_VDD_MPU_OPP100_UV 		1015000 		/* 300 */
#define OMAP4430_VDD_MPU_OPP150_UV 		1056000 		/* 400 */
#define OMAP4430_VDD_MPU_OPP200_UV 		1120000 		/* 500 */
#define OMAP4430_VDD_MPU_OPP250_UV 		1190000 		/* 600 */
#define OMAP4430_VDD_MPU_OPPTURBO_UV 		1251000 		/* 700 */
#define OMAP4430_VDD_MPU_OPPTURBOB_UV 		1305000 		/* 800 */
#define OMAP4430_VDD_MPU_OPPTURBOC_UV 		1350000 		/* 900 */
#define OMAP4430_VDD_MPU_OPPNITRO_UV 		1372000 		/* 1000 */
#define OMAP4430_VDD_MPU_OPPNITROS_UV 		1383000 		/* 1100 */
#define OMAP4430_VDD_MPU_OPPNITROSB_UV 		1395000 		/* 1200 */
#define OMAP4430_VDD_MPU_OPPNITROSBA_UV 	1405000 		/* 1300 */
#else
...
#define OMAP4430_VDD_IVA_OPP100_UV		1087000
#define OMAP4430_VDD_IVA_OPPTURBO_UV		1207000
#define OMAP4430_VDD_IVA_OPPNITRO_UV    	1365000
...
#define OMAP4430_VDD_CORE_OPP50_UV	         902000
#define OMAP4430_VDD_CORE_OPP100_UV		1027000
#define OMAP4430_VDD_CORE_OPP100_OV_UV		1125000
#else
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP25_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0, 0, 0xf4, 0x0c, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_OV_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
};
#else
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP25_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf4, 0x0c, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_OV_UV, 10000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
#endif
