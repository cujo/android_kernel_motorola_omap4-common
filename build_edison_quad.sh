...
export LOCALVERSION="-JBX-1.5-Hybrid-Edison-4.3"
...
echo " "
cp -r /home/dtrail/android/4.3/out/target/product/spyder/system/lib/modules/* /home/dtrail/android/built/4.3/edison/rls/system/lib/modules/
cp /home/dtrail/android/4.3/out/target/product/spyder/kernel /home/dtrail/android/built/4.3/edison/rls/system/etc/kexec/
...
cd /home/dtrail/android/built/4.3/edison/rls
zip -r "JBX-Kernel-1.5-Hybrid-Edison-4.3_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-1.5-Hybrid-Edison-4.3_$(date +"%Y-%m-%d").zip" /home/dtrail/android/out
