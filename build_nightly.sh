...
cp -r /home/dtrail/android/system/out/target/product/spyder/system/lib/modules/* /home/dtrail/android/built/nightly/system/lib/modules/
...
cp arch/arm/boot/zImage /home/dtrail/android/built/nightly/system/etc/kexec/kernel

cd /home/dtrail/android/built/nightly
zip -r "JBX-Kernel-0.7d-Hybrid-Edison-Nightly_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-0.7d-Hybrid-Edison-Nightly_$(date +"%Y-%m-%d").zip" /home/dtrail/android/built
